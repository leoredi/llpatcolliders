...
```bash
# From llpatcolliders/
ls production/madgraph_production/csv/muon/
...
**Solution**:
```bash
# MUST build from production/madgraph_production/ where Dockerfile lives
...
4. **Integrate with analysis**: See `../../analysis_pbc/` for downstream pipeline
...
- [ ] CSV output appears in `production/madgraph_production/csv/muon/`
