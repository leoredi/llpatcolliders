...
cat production/madgraph_production/work/hnl_muon_15.0GeV/Cards/param_card.dat | grep -A5 "Block mass" | grep 9900012

cat production/madgraph_production/work/hnl_muon_15.0GeV/Cards/param_card.dat | grep -A10 "Block numixing"

# 2. Extract sample LHE events (first 150 lines including 1-2 full events)
gunzip -c production/madgraph_production/work/hnl_muon_15.0GeV/Events/run_01/unweighted_events.lhe.gz | head -150

# 3. View CSV output
head -20 production/madgraph_production/csv/muon/HNL_mass_15.0GeV_muon_EW.csv

# 4. View cross-section summary
cat production/madgraph_production/csv/summary_HNL_EW_production.csv
```
...
```
[PASTE: cat production/madgraph_production/work/hnl_muon_15.0GeV/Cards/param_card.dat | grep -A5 "Block mass" | grep 9900012]
```
...
```
[PASTE: cat production/madgraph_production/work/hnl_muon_15.0GeV/Cards/param_card.dat | grep -A10 "Block numixing"]
```
...
```
[PASTE: gunzip -c production/madgraph_production/work/hnl_muon_15.0GeV/Events/run_01/unweighted_events.lhe.gz | head -150]
```
...
```
[PASTE: head -20 production/madgraph_production/csv/muon/HNL_mass_15.0GeV_muon_EW.csv]
```
...
```
[PASTE: cat production/madgraph_production/csv/summary_HNL_EW_production.csv]
```
