...
C     
C     Process: d d~ > vm~ n1 WEIGHTED<=4 @4
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WN1)
      ...
      CALL FFS1_3(W(1,1),W(1,2),GC_141,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,3),W(1,4),W(1,5),GC_89,AMP(1))
      CALL FFV5_6_3(W(1,1),W(1,2),GC_42,GC_38,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV5_0(W(1,3),W(1,4),W(1,5),GC_87,AMP(2))
