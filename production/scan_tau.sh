...
echo $MASSES | xargs -n 1 -P $CORES -I {} sh -c "./main_hnl_single {} $LEPTON > ../output/logs/simulation/log_tau_{}.txt 2>&1"

echo "======================================================="
echo "TAU SCAN COMPLETE."
echo "Results saved to ../output/csv/simulation/HNL_mass_*_tau.csv"
echo "======================================================="
