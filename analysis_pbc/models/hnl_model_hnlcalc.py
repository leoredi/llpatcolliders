...
class HNLModel:
    ...
    def production_brs(self) -> Dict[int, float]:
        ...
        # NOTE: Tau → N X BRs
        # ----------------------------------------------------------------
        # HNLCalc already provides τ→N channels (2-body hadronic and 3-body
        # leptonic). We intentionally DO NOT override br_per_parent[15] here;
        # using the full HNLCalc sum keeps fromTau normalization consistent
        # with the generated τ→N decay mixture.
