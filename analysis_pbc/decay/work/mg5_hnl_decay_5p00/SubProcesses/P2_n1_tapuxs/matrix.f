...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WN1)
      ...
      CALL IXXXXX(P(0,2),MDL_MTA,NHEL(2),-1*IC(2),W(1,2))
      CALL IXXXXX(P(0,3),MDL_MU,NHEL(3),-1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MS,NHEL(4),+1*IC(4),W(1,4))
      CALL FFV5_3(W(1,3),W(1,4),GC_182,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV5_0(W(1,2),W(1,1),W(1,5),GC_107,AMP(1))
