...
case "$LEPTON" in
    electron|e)
        ...
        echo "ELECTRON scan complete. Results: output/csv/simulation/HNL_mass_*_electron.csv"
        ;;
    ...
    muon|mu)
        ...
        echo "Mass points: $MASSES"
        echo $MASSES | xargs -n 1 -P $CORES -I {} sh -c "./main_hnl_single {} $LEPTON_NAME > output/logs/simulation/log_${LEPTON_NAME}_{}.txt 2>&1"
        echo "MUON scan complete. Results: output/csv/simulation/HNL_mass_*_muon.csv"
        ;;
    ...
    tau)
        ...
        echo $MASSES | xargs -n 1 -P $CORES -I {} sh -c "./main_hnl_single {} $LEPTON_NAME > output/logs/simulation/log_${LEPTON_NAME}_{}.txt 2>&1"
        echo "TAU scan complete. Results: output/csv/simulation/HNL_mass_*_tau.csv"
        ;;
